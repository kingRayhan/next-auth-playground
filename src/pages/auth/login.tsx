    ...
    <div className="max-w-6xl mx-auto">
      <div className="w-6/12 mx-auto ">
        ...
        <form action="#" className="flex flex-col gap-2">
          ...
          <div>
            <button className="px-4 py-2 text-white bg-teal-600">Login</button>
          </div>
        </form>
        ...
        <div className="flex flex-col gap-4 mt-4">
          ...
          >
            <svg
              className="w-6 h-6 mr-2 fill-[#181717]"
              role="img"
              viewBox="0 0 24 24"
          ...
          >
            <svg
              className="w-6 h-6 mr-2 fill-[#4285F4]"
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          <button className="flex items-center justify-center px-4 py-2 border">
            <svg
              className="w-6 h-6 mr-2 fill-[#1DA1F2]"
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            >
